...
namespace ros_echronos {
    ...
    class Message {
        public:
             ...
             */
            unsigned int get_next_msg_index() const;
            ...
            /**
             * Records that a decode/fill operation has occured.
             * Used only by Message_Descriptor to handle internal messages
             * @return if the message is finished
             */
            bool record_fill();

            /**
             * populates the descriptor after it has been generated
             * @param descriptor the descriptor generated by generate_descriptor
             */
            virtual void populate_descriptor(void * const descriptor) = 0;
        protected:
            /**
             ...
             */
            virtual Message_Descriptor * generate_descriptor() const = 0;
            /**
             * Function to generate a block
             */
    ...
    inline bool Message::is_done() const {
        return done;
    }
}

...
static const period_ms period[SERVO_COUNT] = {10.0, 13.0};
static const duty_pct neutral[SERVO_COUNT] = {15.0, 6.87}; // 12% for straight
static const double conversion[SERVO_COUNT] = {155.0, 17.53};

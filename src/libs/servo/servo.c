...
static const period_ms period[SERVO_COUNT] = {10.0, 10.0, 10.0};
static const duty_pct neutral[SERVO_COUNT] = {15.0, 15.0, 15.0};
static const double conversion[SERVO_COUNT] = {155.0, 11.25, 10.0};
